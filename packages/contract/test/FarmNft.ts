...
describe('farmNft', function () {
  ...
  describe('mint', function () {
    // NFTをmintした後、 そのNFTの保有者が指定したアドレスと一致するか
    ...
    // mintNFTの実行時にAVAXの移動が正しく行われているのか
    ...
    // 上限までNFTがmintされている場合にmintNFTの呼び出しが失敗することを確認
    ...
    // 関数呼び出しに付与したAVAXが足りない場合に、mintNFTの呼び出しが失敗することを確認
